...
const prices = [
  ...
  { service: 'Изкарване на картофи - градина', price: '30 лв' },
  { service: 'Изкарване на картофи нива 1 декар', price: '50 лв' },
  { service: 'Изкарване на картофи 2 декара', price: '100 лв' },
